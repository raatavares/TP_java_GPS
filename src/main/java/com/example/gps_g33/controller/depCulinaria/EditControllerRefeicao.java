...
public class EditControllerRefeicao {
    ...
    public void setRefeicaoParaEdicao(Refeicao refeicao) {
        ...
        nome_Refeicao.setText(refeicao.getNome());
        descricao_Refeicao.setText(refeicao.getDescricao());
        nif_Refeicao.setText(refeicao.getNif());
        ...
        dataRefeicao_Refeicao.setValue(dataNascimento);
    }
